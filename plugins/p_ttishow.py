...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('🌐 Support', url=f'https://t.me/+hS8TPhJcRvtjMWVl')
            ]]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('📢 Updates', url='https://t.me/+4cU3CekJJ6o2ZWY1')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
